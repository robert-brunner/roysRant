 ...
 */
export const SearchAndReplaceButton = forwardRef(({ className, children, ...props }, ref) => {
  return (
    <Button
      type="button"
      className={className}
...
export const SearchAndReplace = forwardRef((
  ...
  const applyRegexExample = useCallback((pattern, replacement) => {
  ...
  // to the native find.
  useHotkeys(SEARCH_AND_REPLACE_SHORTCUT_KEY, (event) => {
    if (open) {
  ...
  }, { enabled: open && canNavigate }, [goToNext, goToPrevious])
          ...
          <div className="tiptap-search-replace-inputs">
            <InputGroup className="tiptap-search-replace-input-group">
              <InputGroupInput
                ...
                ref={searchInputRef} />
              <InputGroupAddon align="inline-end" className="tiptap-search-replace-keyboard-hint-addon">
            ...
            <div className="tiptap-search-replace-regex-help">
              ...
              <div className="tiptap-search-replace-regex-help-section">
                ...
                <a
                  ...
                  <ExternalLinkIcon className="tiptap-search-replace-regex-docs-link-icon" aria-hidden="true" />
                </a>
              </div>
            </div>
          )}
